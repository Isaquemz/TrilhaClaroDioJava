...
import edu.isaque.todotool.dto.error.CustomErrorResponse;
import edu.isaque.todotool.dto.error.ValidationErrorResponse;
...
public class CustomExceptionHandler {
    ...
    public ResponseEntity<CustomErrorResponse> handleTaskNotFoundExceptionException(
    ...
    public ResponseEntity<CustomErrorResponse> handleTagNotFoundExceptionException(
